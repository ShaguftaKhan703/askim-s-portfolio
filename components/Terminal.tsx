...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(
    () => ({
      python: [
        'print("Hello, World! 👋 I\'m Abdullah Basarvi 🧑‍💻")',
        'print("Based in USA 🗽🌉 Silicon Valley🚀")',
        'print("From AI to Code: Tech Entrepreneur & Software Engineer with 3+ years in AI, Software Development, and Automation, specializing in AI-driven solutions, Full-Stack Development, and Web Design.")',
      ],
      javascript: [
        'console.log("Hello, World! 👋 I\'m Abdullah Basarvi 🧑‍💻");',
        'console.log("Based in USA 🗽🌉 Silicon Valley🚀");',
        'console.log("From AI to Code: Tech Entrepreneur & Software Engineer with 3+ years in AI, Software Development, and Automation, specializing in AI-driven solutions, Full-Stack Development, and Web Design.");',
      ],
    }),
    []
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-primary">abd@portfolio:~$</span>
